...
### 🛠️ 5. Administrative Control Panel (CRUD)
...
* **Database:** MariaDB (Relational schema designed for complex many-to-many course mappings).
* **Backend:** Node.js & Express.js (REST API development).
* **Frontend:** React.js (Responsive dashboard).
